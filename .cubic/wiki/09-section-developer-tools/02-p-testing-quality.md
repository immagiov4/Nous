...
A dedicated script, `select-workflow-postgres-contract.ts`, determines if a change requires a full database contract test by checking file paths against ownership boundaries.
