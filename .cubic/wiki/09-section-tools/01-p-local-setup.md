...
sequenceDiagram
    ...
    Note over Sonar: Start after coverage and provision anonymous analysis
    Sonar-->>Dev: Return quality-gate result
    Note over Sonar: Stop the local service
```
