...
vi.mock('./workspace-reader-shell/WorkspaceReaderBanners.tsx', () => ({
  default: () => <div data-testid="workspace-banners" />,
}));

vi.mock('./workspace-reader-shell/WorkspaceReaderContent.tsx', () => ({
  default: () => <div data-testid="workspace-content" />,
}));

vi.mock('./workspace-reader-shell/WorkspaceReaderHeader.tsx', () => ({
  default: () => <div data-testid="workspace-header" />,
}));

vi.mock('./workspace-reader-shell/WorkspaceReaderOverlays.tsx', () => ({
  default: () => <div data-testid="workspace-overlays" />,
}));

vi.mock('./workspace-reader-shell/WorkspaceReaderSidebar.tsx', () => ({
