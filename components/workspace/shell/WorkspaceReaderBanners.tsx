...
export default function WorkspaceReaderBanners({
  ...
  return (
    <>
      ...
      {pdfMappingWarning ? (
        <div className="mx-4 mt-4 rounded-2xl border border-amber-200 bg-amber-50/80 px-4 py-3 text-sm text-amber-800 dark:border-amber-900/60 dark:bg-amber-950/25 dark:text-amber-200 sm:mx-8 sm:mt-5">
          {pdfMappingWarning}
        </div>
      ) : null}
