...
If Sonar was required but unavailable, I started the existing local service with `bun run sonar:up` and reran the full gate. Every new Sonar finding was fixed or explicitly resolved with an owner-visible disposition.
