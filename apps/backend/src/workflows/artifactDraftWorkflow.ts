...
const explicitRasterPlan = (input: ArtifactDraftWorkflowInput): LessonVisualRetryPlan => {
  ...
  return {
    ...
    coverageRationale: 'The user explicitly requested the visual format.',
    factualRequirements: [],
    interactionLevel: 'none',
    pedagogicalGoal: 'Build a concrete visual reference.',
    reason: 'The visual type was explicitly requested.',
