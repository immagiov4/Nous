...
Primary material governs the lesson. Research dossiers are synthesized claims, not independent original evidence. Preserve original excerpts needed to check dossier claims. Source content marked attributed-note is a research note about that source, not a verbatim page excerpt. A source title or URL alone is not factual support.`;
