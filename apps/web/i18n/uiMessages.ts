...
const ENGLISH_UI_MESSAGES = {
  ...
  Archivio: 'Archive',
  'Archivio originale del corso': 'Original course archive',
  ...
  'Scarica archivio originale': 'Download original archive',
  ...
  'Include pagina, contesto del corso e log recenti raccolti da Nous. Token, email e parametri degli URL vengono rimossi.':
    'Includes the page, course context, and recent logs collected by Nous. Tokens, emails, and URL parameters are removed.',
  ...
  Area: 'Area',
  Attività: 'Activity',
  'Valutazione iniziale': 'Initial assessment',
  'Chat contestuale': 'Contextual chat',
  Pianificazione: 'Planning',
  Lettore: 'Reader',
  'Creazione lezione': 'Lesson creation',
  'Intervista di valutazione': 'Assessment interview',
  'Generazione corso': 'Course generation',
  'Caricamento lezione': 'Lesson loading',
  ...
  'Corso aperto': 'Course opened',
  'Lezione aperta': 'Lesson opened',
  'Attività aggiornata': 'Activity updated',
  'Area visitata': 'Area visited',
  ...
  'Esempio visuale non generato': 'Visual example not generated',
  'Generazione esempio visuale…': 'Generating visual example…',
  'Esempio visuale integrato': 'Visual example added',
  ...
  'Materiali originali usati': 'Original materials used',
  'Pagina {pageStart}': 'Page {pageStart}',
  'Pagine {pageStart}-{pageEnd}': 'Pages {pageStart}-{pageEnd}',
  'Percorsi usati nella lezione': 'Paths used in this lesson',
