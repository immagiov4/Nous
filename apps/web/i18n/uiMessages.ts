...
const ENGLISH_UI_MESSAGES = {
  ...
  'Nome e avatar sono informazioni modificabili del profilo. Email e metodo di accesso provengono dal provider di autenticazione.':
    'Name and avatar are editable profile information. Email and sign-in method come from the authentication provider.',
  ...
  'La scelta riguarda lezioni, pianificazione e chat. Modelli e livelli di ragionamento restano configurati dall’amministratore.':
    'The choice applies to lessons, planning, and chat. Models and reasoning levels remain configured by the administrator.',
  'Provider AI attivo': 'Active AI provider',
  'Provider AI': 'AI provider',
  'Provider AI per le attività testuali': 'AI provider for text tasks',
  'Predefinito del servizio': 'Service default',
