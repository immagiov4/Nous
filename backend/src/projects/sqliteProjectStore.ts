...
const DEFAULT_SQLITE_PATH = './data/lumina-projects.sqlite';
...
const resolveDatabasePath = (): string =>
  resolve(process.env.PROJECT_SQLITE_PATH || DEFAULT_SQLITE_PATH);
...
export class SqliteProjectStore implements ProjectStore {
  ...
  async saveProject(userId: string, data: ProjectSnapshot): Promise<SavedProjectMeta> {
    ...
    if (
      ...
      return existingMeta || buildProjectMeta(existingSnapshot);
    }
