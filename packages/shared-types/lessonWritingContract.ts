...
export const LESSON_LOCAL_PROPEDEUTIC_RULES = [
  ...
  "Quando introduci un nuovo concetto, domanda, tecnica o astrazione, rendi esplicito perche nasce dal ragionamento precedente: formula il problema o la domanda a cui risponde, oppure il limite o l'esigenza che supera. Se questa motivazione appartiene a una sezione diversa, colloca il concetto dopo quella motivazione. Non aggiungere formule fisse quando il collegamento e gia esplicito.",
